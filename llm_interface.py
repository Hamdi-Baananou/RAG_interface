...
WEBSITE_CONFIGS = [
    {
        ...
        "pre_extraction_js": (
            ...
            "        if (searchResults) {"
            "            console.log('Found search results container, looking for exact part match...');"
        ...
        "table_selector": ".technical-data-table, .product-details-table, .specifications-table, table.table, .table-responsive table, .technical-data-content table, .tab-pane table, .tab-content table, [role=tabpanel] table"
    },
    {
        "name": "Mouser",
